    ...
    <div className="container" style={{ padding: '3.5rem 1.5rem' }}>
      <div style={{ maxWidth: '850px', margin: '0 auto 3rem', textAlign: 'center' }}>
        ...
        <p style={{ fontSize: '1.15rem', color: 'var(--color-text-muted)', lineHeight: '1.7', marginTop: '1rem' }}>
          Whether you mentor a woman, volunteer with support services, partner as a founding organization, or donate supplies, your involvement transforms lives.
        </p>
      </div>
      ...
      <div className="grid-2" style={{ gap: '2rem', marginBottom: '4rem' }}>
        ...
        <div className="card hero-track-mentoring">
          ...
          <p style={{ fontSize: '0.96rem', color: 'var(--color-text-main)', marginBottom: '1.25rem', lineHeight: '1.6' }}>
            Become a female peer mentor for our Sisterhood Mentorship Circle or serve as a support volunteer. All volunteers complete background screening and trauma-informed orientation (SOP Section 10).
          </p>
